...
// ==============================================================
`timescale 1ns/1ps
module lzw_encode_hw_control_s_axi
#(parameter
    ...
    input  wire [63:0]                   compressed_size,
...
localparam
    ...
    ADDR_INPUT_SIZE_DATA_0      = 6'h1c,
    ADDR_INPUT_SIZE_DATA_1      = 6'h20,
    ADDR_INPUT_SIZE_CTRL        = 6'h24,
...
always @(posedge ACLK) begin
    if (ARESET)
        int_compressed_size <= 0;
    else if (ACLK_EN) begin
            int_compressed_size <= compressed_size;
    end
end
